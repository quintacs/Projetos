...
<jsp:include page="../cabecalho.jsp" />
	...
	<body onload="setTimeout(ocultaResposta, 3000)">
	  ...
	  <div class="header">
		 <h1>Qi Auto Peças - Loja </h1>  		
		 <p> Sua melhor opção em peças automotivas </p>
	  </div>
	    <div class="conteudo-form">
			<div class="col-3 col-s-3 menu">
			<ul>
				<li id="voltar" onclick="javascript:load('form','Usuario','index');"  >
					Voltar
				</li>				
			</ul>			
			</div>
			<div class="col-6 col-s-9">
				<div class="w3-content w3-display-container">
							...
							<input type="hidden" name="idUsuario" id="idUsuario" class="coluna-75" >  
							
								<div class="row" > 	
									<span class="coluna-25" >Nome* </span>
									<input type="text" name="nome" id="nome" value="${usuarioForm.nome}" class="coluna-75" >  
								</div>
								
								<div class="row" > 	
									<span class="coluna-25" >CPF* </span>
									<input type="text" name="cpf" id="cpf" value="${usuarioForm.cpf}" 
										onKeyPress="return Apenas_Numeros(event);" class="coluna-75" 
										maxlength="14" onkeyup="mascaraCPF(this);">  
								</div>								
																
								<div class="row" > 	
									<span class="coluna-25" >Telefone*</span>
									<input type="text" name="telefone" id="telefone" value="${usuarioForm.telefone}" class="coluna-75" 
											onKeyPress="return Apenas_Numeros(event);" MaxLength="13"	
											onkeyup="mascaraTelefone(this);"  >  
								</div>																
								<div class="row" > 	
									<span class="coluna-25" >Celular*</span>
									<input type="text" name="celular" id="celular" value="${usuarioForm.celular}" class="coluna-75"
										onKeyPress="return Apenas_Numeros(event);" MaxLength="14" 
										onkeyup="mascaraTelefone(this);"  >  
								</div>									
								<div class="row" > 	
									<span class="coluna-25" >Email*</span>
									<input type="text" name="email" id="email" value="${usuarioForm.email}" 
									onblur="validacaoEmail(this);"  class="coluna-75" > 
								</div>
								<div class="row" > 	
									<span class="coluna-25" >Endereço*</span>
									<input type="text" name="endereco" id="endereco" value="${usuarioForm.endereco}" class="coluna-75" > 
								</div>								
								<!-- 								
								<div class="row" > 	
								...
								<div class="row" > 
									...
									<input type="password" name="senha" id="senha" value="${usuarioForm.loginForm.senha}" class="coluna-75" >
								</div>
								<div class="row" > 
									<span  class="coluna-25">Confirmar Senha*</span>
									<input type="password" name="csenha" value="${usuarioForm.loginForm.csenha}" class="coluna-75" >
								</div>				
								<div class="row">																				
									<input type="submit" value="Enviar"  onclick="javascript:load('form','Usuario','form');">
								</div> 																				
				</div>						
			</div>
